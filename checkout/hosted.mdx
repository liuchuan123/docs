---
title: "托管收银台"
description: "使用 PMP Payment 托管收银台完成支付接入"
---


托管收银台是 PMP Payment 提供的开箱即用的支付页面，商户只需将用户重定向到该页面即可完成支付。
...
**HTTP 重定向**（推荐）：
```
HTTP 302 Location: https://checkout.example.com/pay/1000126011700000100001
```
