---
title: 概览
description: PayMatrix 开放平台使用与接入指南
---

PayMatrix 是一站式收款平台，帮助商户接受、管理并结算多币种支付。你只需接入一次，即可获得完整的收银、对账、结算与风控能力——底层支付处理由平台统一完成，对你透明。
...
准备好开始了吗？前往 [快速开始](/getting-started/quickstart)。
